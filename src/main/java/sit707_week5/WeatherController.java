...
public class WeatherController {
	 ...
	 * @return
	 */
	public static WeatherController getInstance(MyDate myDate) {
		if (instance == null) {
			instance = new WeatherController(myDate);
		}
		return instance;
	}
	 ...
	 */
	WeatherController(MyDate myDate) {
	...
	public String persistTemperature(int hour, double temperature) {
		...
		String savedTime = sdf.format(myDate.getDate());
